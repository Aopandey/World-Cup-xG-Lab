...
import { formatNumber, initials, shortLeagueName, slugPath } from "@/lib/format";
        ...
        <div className="min-w-0 flex-1">
          ...
          {player.statsbomb_shots > 0 ? (
            <p className="mt-3 text-xs text-slate-400">
              {formatNumber(player.total_xg, 2)} historical xG from {formatNumber(player.statsbomb_shots)} shots
            </p>
          ) : null}
        </div>
      </div>
